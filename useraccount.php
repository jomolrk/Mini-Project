...
<body>
	...
	<div class="wrap">
		...
		<div class="header">
			...
			<div id="heading">
				<a href="userindex.php" style="color:orangered"></a>
			</div>
			</div>
		</div>
		<!-- Navigation bar -->
		<div class="navbar navbar-inverse" >
			<div class="navbar-inner">
				...
				<a class="brand" href="userindex.php" >Back to Your dashboard </a>
		...
		<div class="span12 well pass1">
			...
			<table class="table">
			<tr><td >Fullname: <td style="text-transform:capitalize;"><?php if($row!=null){ echo $row['reg_name']; } ?></td></td></tr>
			...
			<tr>
				<td>
				<span style="width:35%;"><a href="changepass.php">Change Password</a></span>
				...
				<td>
				<span style="width:55%;"><a href="editpro.php">edit profile</a></span>
				<span class="label label-success" id="chang" style="float:right;display:none;">profile Successfully Changed &nbsp;&nbsp;&nbsp;<span>  <!-- display:none; color:#0000ff;-->
				</td>
			</tr>
		</table>
		</div>
		...
		<div class="span8 well">
			...
			<tr>
				<td>
				<span style="width:35%;"><a href="editpro.php">edit profile</span>
