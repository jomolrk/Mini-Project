                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td><select id="type" class="form-control" name="type"  value="<?php echo $fetch['type']; ?>"></td>
                                                    <td>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="post">
                                                                <input type="hidden" class="form-control" name="id" value="<?php echo $id ?>" required id="">
                                                                    ...
                                                                    <p> 1A: <input type="number" min='0' class="form-control" value="<?php echo $fetch['1A'] ?>" name="1a" required id=""></p>
                                                                    <p> 2A : <input type="number" min='0' class="form-control" value="<?php echo $fetch['2a'] ?>" name="2a" required id=""></p>
                                                                <p>3A: <input type="number" min='0' class="form-control" value="<?php echo $fetch['3a'] ?>" name="3a" required id=""></p>
                                                                <p> Upper_Seat: <input type="number" min='0' class="form-control" value="<?php echo $fetch['Upper_seat'] ?>" name="ua" required id=""></p>
