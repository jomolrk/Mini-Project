...
<!-- banner -->
	<div class="center-container">
	    <div class="main">
	        <h1 class="w3layouts_head">Train List</h1>
	           <div class="w3layouts_main_grid">
                                         ...
                                         <div class="w3_agileits_main_grid w3l_main_grid">
                                              ...
                                              <table class="table table-bordered" id="train-list">
			<colgroup>
		       ...
		       <thead>
		        ...
		        <th class="text-center">First seat</th>
							
		        <th class="text-center">second seat</th>
			...
			$qry = $conn->query("SELECT * FROM train ");
		...
		<tr>
	                    ...
	                    <td class="text-right"><?php echo $row['name'] ?></td>
                                        <td class="text-right"><?php echo number_format($row['first_seat'],2) ?></td>
                                        <td class="text-right"><?php echo number_format($row['second_seat'],2 )?></td>
