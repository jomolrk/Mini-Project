...
$sql1="SELECT ".$seat." from seat where train_name='".$tname."' and doj='".$doj."'";
...
if($value>0){
	...
	$value-=1;
$sql2="UPDATE seats_availability SET ".$seat."=".$value." WHERE doj='".$doj."' and train_name=".$tname."";
	...
	if(!$result) die ($conn->error);
	$value-=1;
	$sql2="UPDATE seat SET ".$seat."=".$value." WHERE doj='".$doj."' and train_name	=".$tname."";
	$result2=$conn->query($sql2);
	echo "</br>".$sql2."</br>";
	if(!$result) die ($conn->error);
	}
