	...
	<div class="wrap">
		...
		<form action="#" method="POST">
			...
			<table class="tbl-30">
				...
				<tr>
					<td colspan="2"><a href="userindex.php"><input type="button" name="reset" value="Home" /></a><br><br></td>
				</tr>
			</table>
		</form>
	</div>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * from tbl_login WHERE  log_emailid='$email_id' and log_pass='$current_password ' and log_type='user'";
